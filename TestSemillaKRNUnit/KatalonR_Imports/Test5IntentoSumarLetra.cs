...
namespace TestSemillaKRNUnit.KatalonR_Imports
{
    ...
    public class Test5IntentoSumarLetra
    {
        ...
        [Test]
        public void The5IntentoSumarLetraTest()
        {
            ...
            new SelectElement(driver.FindElement(By.Id("selectOperationDropdown"))).SelectByText("Multiply");
            driver.FindElement(By.Id("calculateButton")).Click();
            driver.FindElement(By.Id("selectOperationDropdown")).Click();
            new SelectElement(driver.FindElement(By.Id("selectOperationDropdown"))).SelectByText("Concatenate");
            driver.FindElement(By.Id("calculateButton")).Click();
